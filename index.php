    ...
    <div class="popup-bg" id="loginScreen">
        <div class="popup">
            ...
            <form method="post" id="login">
                <label for="email-address-login" class="subtitle">Email Address</label><br>
                <input type="email" id="email-address-login" name="email-address" autocomplete="username" required class="text-input"><br>
                <p class="error-message">Error message</p>
                <label for="password-login" class="subtitle">Password</label><br>
                <input type="password" id="password-login" name="password" required class="text-input"><br>
                <p class="error-message">Error message</p>
                <button type="submit" class="button">Login</button>
                <h4 class="subtitle" id="signup-popup" onclick='show("signupScreen"); hide("loginScreen");'>Don't have an account? Sign up.</h4>
            </form>
        </div>
    </div>
    ...
    <div class="popup-bg" id="signupScreen">
        <div class="popup">
            ...
            <form method="post" id="signup">
                ...
                <p class="error-message">Error message</p>
                <label for="password-signup" class="subtitle">Password</label><br>
                <input type="password" id="password-signup" name="password" required class="text-input"><br>
                <p class="error-message">Error message</p>
                <label for="country" class="subtitle">Select Your Country</label><br>
                ...
                <h4 class="subtitle" id="login-popup-alt" onclick='hide("signupScreen"); show("loginScreen");'>Already have an account? Log in.</h4>
            </form>
        </div>
    </div>
